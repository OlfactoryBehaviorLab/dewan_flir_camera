...
class MainUI(object):
    ...
    def setupUi(self, main_window):
        ...
        main_window.setStyleSheet(u"font: 12pt \"Arial\";")
        ...
        self.param_header.setObjectName(u"param_header")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.param_header.sizePolicy().hasHeightForWidth())
        self.param_header.setSizePolicy(sizePolicy4)
        self.param_header.setStyleSheet(u"border-bottom-width: 2px;\n"
...
"font: 700 16pt \"Arial\";")
        ...
        sizePolicy4.setHeightForWidth(self.current_exposure_widget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.current_exposure_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.current_exposure_data.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.current_framerate_widget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.current_fps_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.current_fps_data.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.max_framerate_widget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.max_fps_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.max_fps_data.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.s_per_trial_widget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.s_per_trial_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.s_per_trial_data.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy4.setHeightForWidth(self.num_frames_widget.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.num_frames_label.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.num_frames_data.sizePolicy().hasHeightForWidth())
        ...
        self.controls_header.setObjectName(u"controls_header")
        sizePolicy4.setHeightForWidth(self.controls_header.sizePolicy().hasHeightForWidth())
        self.controls_header.setSizePolicy(sizePolicy4)
        self.controls_header.setStyleSheet(u"border-top-width: 2px;\n"
...
"font: 700 16pt \"Arial\";")
        ...
        sizePolicy8.setHeightForWidth(self.acquisition_mode.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy8.setHeightForWidth(self.exposure_control.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy7.setHeightForWidth(self.center_apply_button.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy9.setHeightForWidth(self.exposure_apply.sizePolicy().hasHeightForWidth())
        ...
        self.arm_button.setStyleSheet(u"QPushButton{\n"
...
"}")
        ...
        sizePolicy8.setHeightForWidth(self.capture_button.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy8.setHeightForWidth(self.start_button.sizePolicy().hasHeightForWidth())
...
"}")
    ...
    def retranslateUi(self, main_window):
        ...
        self.param_header.setText(QCoreApplication.translate("main_window", u"Parameters", None))
        ...
        self.arm_button.setText(QCoreApplication.translate("main_window", u"ARM TRIGGER", None))
        self.capture_button.setText(QCoreApplication.translate("main_window", u"SINGLE", None))
        self.start_button.setText(QCoreApplication.translate("main_window", u"START ACQUISITION", None))
