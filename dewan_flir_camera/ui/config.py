...
class Ui_config_wizard(object):
    def setupUi(self, config_wizard):
        if not config_wizard.objectName():
            config_wizard.setObjectName(u"config_wizard")
        ...
        config_wizard.setWindowTitle(u"Experiment Configuration")
        config_wizard.setStyleSheet(u"font: 12pt \"Arial\";")
        ...
        self.header.setStyleSheet(u"border-bottom-width: 2px;\n"
...
"font: 16pt \"Arial\";")
        ...
        self.button_center_layout.setObjectName(u"button_center_layout")
        ...
        self.mouse_ID_field.setObjectName(u"mouse_ID_field")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.mouse_ID_field.sizePolicy().hasHeightForWidth())
        ...
        self.experiment_type_field.setObjectName(u"experiment_type_field")
        sizePolicy3.setHeightForWidth(self.experiment_type_field.sizePolicy().hasHeightForWidth())
        self.experiment_type_field.setSizePolicy(sizePolicy3)
        self.experiment_type_field.setInputMask(u"")
        self.experiment_type_field.setFrame(True)
        self.experiment_type_field.setPlaceholderText(u"Experiment Name")

        self.control_layout.addWidget(self.experiment_type_field, 1, 2, 1, 1)

        self.experiment_type_label = QLabel(config_wizard)
        self.experiment_type_label.setObjectName(u"experiment_type_label")
        sizePolicy1.setHeightForWidth(self.experiment_type_label.sizePolicy().hasHeightForWidth())
        ...
        self.mouse_ID_label.setObjectName(u"mouse_ID_label")
        sizePolicy1.setHeightForWidth(self.mouse_ID_label.sizePolicy().hasHeightForWidth())
        self.mouse_ID_label.setSizePolicy(sizePolicy1)
#if QT_CONFIG(accessibility)
        self.mouse_ID_label.setAccessibleName(u"")
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.mouse_ID_label.setAccessibleDescription(u"")
#endif // QT_CONFIG(accessibility)
        self.mouse_ID_label.setAccessibleIdentifier(u"")
        ...
        self.dir_input_layout.setObjectName(u"dir_input_layout")
        self.save_path_field = QLineEdit(config_wizard)
        self.save_path_field.setObjectName(u"save_path_field")
        ...
        sizePolicy4.setHeightForWidth(self.open_dir_button.sizePolicy().hasHeightForWidth())
        ...
        self.open_dir_button.setStyleSheet(u"")
#if QT_CONFIG(shortcut)
        self.open_dir_button.setShortcut(u"")
    ...
    def retranslateUi(self, config_wizard):
        self.header.setText(QCoreApplication.translate("config_wizard", u"Configure Experiment", None))
        self.confirm_button.setText(QCoreApplication.translate("config_wizard", u"Confirm", None))
        self.mouse_ID_field.setPlaceholderText(QCoreApplication.translate("config_wizard", u"Mouse ID", None))
        self.experiment_type_label.setText(QCoreApplication.translate("config_wizard", u"Experiment:", None))
        self.mouse_ID_label.setText(QCoreApplication.translate("config_wizard", u"Mouse ID:", None))
        self.save_path_field.setPlaceholderText(QCoreApplication.translate("config_wizard", u"Save Directory", None))
        self.open_dir_button.setText(QCoreApplication.translate("config_wizard", u"Open", None))
        self.save_dir_label.setText(QCoreApplication.translate("config_wizard", u"Save Directory:", None))
        pass
    # retranslateUi
