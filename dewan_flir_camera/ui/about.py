...
class About(QDialog):
    ...
    def setupUi(self, about):
        ...
        self.top_row_layout.setObjectName("top_row_layout")
        ...
        self.image.setPixmap(QPixmap(":/resources/images/mouse.jpg"))
        ...
        self.github_link.setStyleSheet("color: rgb(0, 85, 255)")
        ...
        sizePolicy4.setHeightForWidth(
            self.website_link.sizePolicy().hasHeightForWidth()
        )
        self.website_link.setSizePolicy(sizePolicy4)
        self.website_link.setFont(font)
        self.website_link.setStyleSheet("color: rgb(0, 85, 255)")
        self.website_link.setOpenExternalLinks(True)
        self.website_link.setTextInteractionFlags(
            Qt.TextInteractionFlag.LinksAccessibleByKeyboard
            | Qt.TextInteractionFlag.LinksAccessibleByMouse
        )
    ...
    def retranslateUi(self, about):
        ...
        self.name.setText(
            QCoreApplication.translate(
                "about", "Dewan Lab FLIR Blackfly S Camera Acquisition Controller", None
            )
        )
        ...
        self.version.setText(QCoreApplication.translate("about", "v 1.0", None))
        self.github_link.setText(
            QCoreApplication.translate(
                "about",
                '<html><head/><body><p><a href="htps://github.com/OlfactoryBehaviorLab/"><span style=" text-decoration: underline; color:#69fcff;">htps://github.com/OlfactoryBehaviorLab/</span></a></p></body></html>',
                None,
            )
        )
        self.website_link.setText(
            QCoreApplication.translate(
                "about",
                '<html><head/><body><p><a href="https://dewanlab.neuro.fsu.edu/"><span style=" text-decoration: underline; color:#69fcff;">https://dewanlab.neuro.fsu.edu/</span></a></p></body></html>',
                None,
            )
        )
